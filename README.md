...
```
- [ ] All images MUST be embedded into a single CSS file. Checkout [base64](https://www.base64-image.de/) for how to do this.
...
- [ ] Try to keep the number of files to a minimum. 100 x 1k files is far slower than a single 100K file. 
